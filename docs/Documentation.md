...
![Deleting_Databus_Publication_next_window](graphics/Deleting_Databus_Publication_1_next_window.png)
...
![Deleting_Databus_Publication_next_window](graphics/Deleting_Databus_Publication_2_next_window.png)
...
The parameters of sinus wave can be changed in TIA portal project by setting of corresponding values
- sinusParameter.freq
