...
The used TIA Portal project (Tank Application) can be found in the [src](src) directory under the following name and is also used for several further application examples: [HowTos_Sinus_Wave.7z](src/HowTos_Sinus_Wave.7z)
